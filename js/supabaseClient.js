...
function rotaPendentePrimeiroAcesso(perfil) {
    if (perfil?.deve_alterar_password) return "redefinir-password.html?primeiro=1";
...
async function exigirRole(rolesPermitidos) {
    ...
    const rotaPendente = rotaPendentePrimeiroAcesso(perfil);
    if (rotaPendente) {
