...
const VERSAO_FRONTEND = "R3.3-A.4.4";
...
function mostrarBackendDesatualizadoR323(estado = null) {
    ...
    aviso.innerHTML = `<strong>Atualização incompleta</strong><p>A aplicação ${VERSAO_FRONTEND} encontrou a versão ${versaoBackend} na base de dados. Pede ao Super Admin para executar a migration 39 de estabilização E2E. Nenhuma operação foi realizada.</p>`;
