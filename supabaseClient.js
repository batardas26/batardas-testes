...
const VERSAO_FRONTEND = "R3.3-A.2";
...
function mostrarBackendDesatualizadoR323() {
    ...
    aviso.innerHTML = `<strong>Atualização incompleta</strong><p>A aplicação ${VERSAO_FRONTEND} não encontrou a mesma versão na base de dados. Pede ao Super Admin para executar a migration 30 da entrega obrigatória. Nenhuma operação foi realizada.</p>`;
